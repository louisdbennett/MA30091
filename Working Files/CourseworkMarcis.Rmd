...
model_formulas = list(
  ...
  glm7 = current_smoker ~ I(age^2) * marital_status + level_of_deprivation*rural + ethnicity + educ + gender
)
...
lmS4 = lm(systolic ~ current_smoker*I(age^2) + nr_cigarettes_weekly + marital_status_ + level_of_deprivation + 
    rural + ethnicity + educ_ + BMI + gender_ + current_e_cig_user + drinks_, dataS)
