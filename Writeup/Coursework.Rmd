...
model_specs <- c(
  "$\\logit(\\mu_i) \\sim a_i + a_i^2 + ms_i + q_i + u_i + o_i + t_i + s_i + q_i:u_i$",
  "$\\logit(\\mu_i) \\sim a_i + a_i^2 + ms_i + q_i + u_i + o_i + t_i + s_i$",
  "$\\logit(\\mu_i) \\sim a_i + ms_i + q_i + u_i + o_i + t_i + s_i$",
  "$\\logit(\\mu_i) \\sim a_i^{(5)} + ms_i + q_i + u_i + o_i + t_i + s_i$",
  "$\\logit(\\mu_i) \\sim a_i^{(10)} + ms_i + q_i + u_i + o_i + t_i + s_i$"
)
...
$$\logit(\mu_i) \sim \beta_0 + \beta_1a + \beta_2a^2 + \beta_3q + \alpha^{ms}_j + \alpha^{u}_k + \alpha^{o}_l + \alpha^{t}_m + \alpha^{s}_n$$
