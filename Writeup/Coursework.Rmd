...
create_confidence_int_plot('qimd19', 'Sex', 'cigsta3_19', required_levels = c('Current cigarette smoker'), list(x = 'Deprivation Level', y = '% Smokers'))
```
...
**Why did we remove outliers**

**Question Three**

```{r output qq plot for q3, include = T, fig.height=4, fig.width=4, fig.align='center', fig.cap="Q-Q plot of Inverse-Normal model residuals"}
