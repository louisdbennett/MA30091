...
sd16plus <- subdat %>% 
  ...
  mutate(
    ...
    current_smoker = as.factor(cigsta3_19 == "Current cigarette smoker"),
    age_estim =
      case_when(
...
# Remove superfluous factor levels

sd16plus$Sex = droplevels(sd16plus$Sex)
sd16plus$ag16g10 = droplevels(sd16plus$ag16g10)
sd16plus$Age35g = droplevels(sd16plus$Age35g)
sd16plus$topqual2 = droplevels(sd16plus$topqual2)
sd16plus$origin2 = droplevels(sd16plus$origin2)
sd16plus$cigsta3_19 = droplevels(sd16plus$cigsta3_19)
sd16plus$drinkYN_19 = droplevels(sd16plus$drinkYN_19)
sd16plus$GOR1 = droplevels(sd16plus$GOR1)
```
